...
if (file_exists("vanilla.spp")) {
		$realm_db['name']     = 'vanilla_realmd';
	}
	else
	{
		$realm_db['name']     = 'tbc_realmd';
	}
...
$world_db[1]['name']          = 'vanilla_world';         // World Database name, by default "mangos" for MaNGOS, "world" for Trinity
...
$world_db[2]['name']          = 'tbc_world';         // World Database name, by default "mangos" for MaNGOS, "world" for Trinity
...
$world_db[3]['name']          = 'wotlk_world';         // World Database name, by default "mangos" for MaNGOS, "world" for Trinity
...
$characters_db[1]['name']     = 'vanilla_characters';     // Character Database name
...
$characters_db[2]['name']     = 'tbc_characters';     // Character Database name
...
$characters_db[3]['name']     = 'wotlk_characters';     // Character Database name
...
$server[2]['game_port']     =  8086;       // Game Server port
...
$server[3]['game_port']     =  8087;       // Game Server port
